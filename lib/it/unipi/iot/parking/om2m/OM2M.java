...
public class OM2M {
	...
	public Resource create(String parentID, int resourceType, String... options) {
		switch (resourceType) {
	...
	public Subscription createSubscription(String parentID, String subscriberURI) {
		...
		object.put(ATTR_NOTIFICATION_URI, subscriberURI);
		object.put(ATTR_NOTIFICATION_CONTENT_TYPE, ATTR_NCT_CONTENT);
	...
	public JSONObject getResourceFromID(String resourceID, int resourceType) {
	...
	static public String getResourceString(int resourceType) {
		switch (resourceType) {
		case RESOURCE_TYPE_APPLICATION_ENTITY:
	...
	public Resource create(String parentID, Resource original) {
